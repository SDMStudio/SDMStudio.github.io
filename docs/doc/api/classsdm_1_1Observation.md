...
[**Class List**](annotated.md) **>** [**sdm**](namespacesdm.md) **>** [**Observation**](classsdm_1_1Observation.md)



_A public interface for observations._ [More...](#detailed-description)

* `#include <observation.hpp>`



Inherits the following classes: [sdm::Item](classsdm_1_1Item.md)


Inherited by the following classes: [sdm::BaseObservation](classsdm_1_1BaseObservation.md),  [sdm::State](classsdm_1_1State.md)
...
Any class inheriting from this interface will be considered as generic observation for algorithms. Consider sections [Theoritical Background](https://aldavid.gitlabpages.inria.fr/sdms/tutorials/theory.html) and [Algorithms](https://aldavid.gitlabpages.inria.fr/sdms/tutorials/algorithms/) for more information. 
