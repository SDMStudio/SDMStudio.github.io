...
# Class sdm::SerialMPOMDPInterface
...
[**Class List**](annotated.md) **>** [**sdm**](namespacesdm.md) **>** [**SerialMPOMDPInterface**](classsdm_1_1SerialMPOMDPInterface.md)
...
Inherits the following classes: [sdm::SerialMMDPInterface](classsdm_1_1SerialMMDPInterface.md),  [sdm::MPOMDPInterface](classsdm_1_1MPOMDPInterface.md)
...
```cpp
virtual std::shared_ptr< Joint < std::shared_ptr< Observation > > > sdm::SerialMPOMDPInterface::getDefaultObservation () const = 0
```
